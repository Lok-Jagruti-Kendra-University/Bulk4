...
def fetch_sonarcloud_score():
    ...
    params = {
        "component": "Lok-Jagruti-Kendra-University_Bulk4",  # Your SonarCloud project key
        "branch":"main",
        "ps":500,
...
SONARCLOUD_URL = "https://sonarcloud.io/summary/overall?id=Lok-Jagruti-Kendra-University_Bulk4&branch=main"
